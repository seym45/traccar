...
public class Gt06aProtocolEncoder extends BaseProtocolEncoder {

    public Gt06aProtocolEncoder(Protocol protocol) {
        super(protocol);
    }
    ...
    private ByteBuf encodeContent(long deviceId, String content) {
        ...
        buf.writeByte(Gt06aProtocolDecoder.MSG_COMMAND_0);
